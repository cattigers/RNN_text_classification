...
gsutil cp char-train-${MAX_DOC_LENGTH}.tfrecords gs://vinh-tutorial/data/dbpedia/charRNN/${MAX_DOC_LENGTH}/
gsutil cp char-test-${MAX_DOC_LENGTH}.tfrecords gs://vinh-tutorial/data/dbpedia/charRNN/${MAX_DOC_LENGTH}/
...
python text_classification_TPU_withTFRecords.py \
 ...
 --num_cores=8 \
 --learning_rate=0.1 \
 --data_dir=gs://vinh-tutorial/data/dbpedia/charRNN/${MAX_DOC_LENGTH} \
 --rnn_size=128 \
